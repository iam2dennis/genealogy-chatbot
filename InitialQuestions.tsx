    ...
    <div className="p-6 flex flex-col justify-center items-center h-full text-center">
      <div className="w-full max-w-md">
        ...
        <div className="text-slate-600 mb-6 space-y-4">
            ...
            <div className="text-sm bg-yellow-50 border-l-4 border-yellow-400 p-3 text-left text-yellow-800">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="text-left">
            ...
            <select
              ...
              className="w-full p-2 border border-slate-300 rounded-md shadow-sm focus:ring-2 focus:ring-slate-500 focus:outline-none transition duration-200"
            >
          ...
          <div className="text-left">
            ...
            <div className="flex space-x-4">
              <button
                ...
                className={`flex-1 p-3 border rounded-md text-sm transition-all duration-200 ${answerType === 'detailed' ? 'bg-slate-600 text-white border-slate-600 shadow-md' : 'bg-white text-slate-700 hover:bg-slate-50'}`}
              >
                Detailed Answer
              </button>
              <button
                 ...
                 className={`flex-1 p-3 border rounded-md text-sm transition-all duration-200 ${answerType === 'step-by-step' ? 'bg-slate-600 text-white border-slate-600 shadow-md' : 'bg-white text-slate-700 hover:bg-slate-50'}`}
              >
                Step-by-Step
              </button>
            </div>
          ...
          <button
            type="submit"
            className="w-full p-3 bg-slate-600 text-white rounded-md font-semibold hover:bg-slate-700 focus:outline-none focus:ring-2 focus:ring-slate-500 focus:ring-offset-2 transition duration-200"
          >
            Start Chatting
          </button>
        </form>
